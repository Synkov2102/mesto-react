            ...
            <section className="profile">
                <div className="profile__container">
                    <div className="profile__avatar"style={{ backgroundImage: `url(${userAvatar})` }} onClick ={props.onEditAvatar}>
                        <img className="profile__pen-icon" src = {penIconPath} alt="Иконка редактирования аватарки"/>
                    </div>
                    <div className="profile__info">
                        <div className="profile__name-container">
                            <h1 className="profile__name">{userName}</h1>
                            <button type="button" onClick ={props.onEditProfile} className="profile__edit-button">
                                <img className="profile__image-edit-button" src={editIconPath}
                ...
                <button type="button" className="profile__add-button" onClick ={props.onAddPlace}>
                    <img className="profile__image-add-button" src={addIconPath}
